...
export function AdminPortal() {
    ...
    return (
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-sm border border-neutral-200 overflow-hidden text-center p-12">
        ...
        <p className="text-neutral-500 mb-6">
          You must sign in with Google to upload documents to Google Drive and
          the database.
        </p>
        <button
          onClick={handleLogin}
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10">
      ...
      {!driveToken ? (
        <div className="bg-white rounded-[2rem] shadow-xl border border-neutral-100 overflow-hidden text-center p-16 relative">
          ...
          <div className="relative z-10 flex flex-col items-center">
            <div className="h-24 w-24 bg-gradient-to-tr from-red-100 to-red-50 text-red-600 rounded-3xl flex items-center justify-center mb-6 shadow-sm border border-red-200">
              <UploadCloud className="h-10 w-10 text-red-600" />
            </div>
            <h3 className="text-3xl font-extrabold text-neutral-900 mb-4 tracking-tight">
              Connect Google Drive
            </h3>
            <p className="text-lg text-neutral-500 mb-8 max-w-lg mx-auto font-medium">
              Please authorize access to Google Drive so official documents can
              be securely uploaded directly to cloud storage.
            </p>
            <button
              onClick={handleLogin}
              className="px-8 py-3 bg-red-600 text-white font-bold rounded-xl shadow-lg hover:bg-red-700 hover:shadow-red-600/30 transition-all transform hover:-translate-y-0.5 text-lg"
            >
              Authorize Google Drive
            </button>
            {submitError && (
              <p className="text-red-500 mt-6 font-medium text-sm bg-red-50 p-3 rounded-lg border border-red-200">
                {submitError}
              </p>
            )}
          </div>
        ...
        <div className="bg-white rounded-[2rem] shadow-xl border border-neutral-100 overflow-hidden relative">
          <div className="p-8 border-b border-neutral-100 bg-gradient-to-r from-neutral-50 to-white">
            ...
            <p className="text-neutral-500 mt-2 font-medium">
              Submit new letters or files to the correspondence system.
            </p>
          </div>
            ...
            {success && (
              <div className="bg-green-50 text-green-700 p-4 rounded-md flex items-center mb-6 border border-green-200">
                ...
                <p className="text-sm font-medium">
                  Document uploaded to Google Drive and saved successfully!
                </p>
              </div>
            )}
            ...
            <div className="p-6 border-t border-neutral-200">
              ...
              <div className="space-y-3">
                {userDocs.map((doc) => (
                  <div
                    key={doc.id}
                    className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 p-4 border border-neutral-200 rounded-lg bg-neutral-50"
                  >
